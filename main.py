...
parser.add_argument("mode", help="Trains or tests the CNN", nargs='+', choices=["train", "test", "slice", "analyse"])
...
if "analyse" in args.mode:
    # Test 1 image and analyse it using occluder
    test_X, test_y = getDataset(filesPerGenre, genres, sliceSize, validationRatio, testRatio, mode="analyse")
